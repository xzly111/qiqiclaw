"""Shared CLI output helpers for QiQiClaw CLI modules.
...
def prompt(
    ...
    try:
        # Show typed characters so users can see and paste API keys.
        # getpass() blocks paste in some terminals (Windows Terminal / WSL).
        value = input(display)
        value = value.strip()
