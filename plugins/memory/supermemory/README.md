...
it groups QiQiClaw-written memories into a dedicated "QiQiClaw" Space in the
...
Use `{identity}` in the `container_tag` to scope memories per QiQiClaw profile:
