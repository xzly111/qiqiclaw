# QiQi claw Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.qiqiclaw/plugins/qiqiclaw-achievements/state.json` (existing unlock state)
  - `~/.qiqiclaw/plugins/qiqiclaw-achievements/scan_snapshot.json` (new)
  - `~/.qiqiclaw/plugins/qiqiclaw-achievements/scan_checkpoint.json` (new)
