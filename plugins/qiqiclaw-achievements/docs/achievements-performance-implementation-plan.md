# QiQi claw Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.qiqiclaw/plugins/qiqiclaw-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.qiqiclaw/plugins/qiqiclaw-achievements/scan_checkpoint.json`.
