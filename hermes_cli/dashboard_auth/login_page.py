...
<body>
<main>
  <div class="brand">QiQi<span class="dot"></span>Claw</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the QiQiClaw dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — QiQiClaw</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
