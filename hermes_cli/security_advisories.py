"""
Security advisory checker for QiQiClaw.
...
ADVISORIES: tuple[Advisory, ...] = (
    Advisory(
        ...
        remediation=(
            ...
            "Rotate API keys in ~/.qiqiclaw/.env (OpenRouter, Anthropic, OpenAI, "
...
# ``~/.qiqiclaw/cache/advisory_banner_seen`` (a single line per advisory ID:
