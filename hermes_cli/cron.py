...
def cron_list(show_all: bool = False):
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: qiqiclaw gateway install", Colors.DIM))
        print(color("                    sudo qiqiclaw gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    qiqiclaw gateway install    # Install as a user service")
        print("    sudo qiqiclaw gateway install --system  # Linux servers: boot-time system service")
        print("    qiqiclaw gateway            # Or run in foreground")
...
def cron_create(args):
    ...
    if _contains_gateway_lifecycle_command(combined):
        print(color(
            ...
            "Use `qiqiclaw gateway restart` from a shell outside the gateway.",
            Colors.RED,
        ))
        return 1
