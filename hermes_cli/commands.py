...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of QIQI-Claw config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal QIQI-Claw works on across turns until achieved", "Session",
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("reload-skills", "Re-scan ~/.qiqiclaw/skills/ for newly installed or removed skills",
    ...
    CommandDef("update", "Update QiQiClaw to the latest version", "Info"),
    CommandDef("version", "Show QiQiClaw version", "Info", aliases=("v",)),
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to QIQI-Claw or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
