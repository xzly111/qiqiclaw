"""QiQiClaw CLI skin/theme engine.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic QiQiClaw — gold and kawaii",
        "colors": {
    ...
    "ares": {
        ...
        "branding": {
            "agent_name": "QiQiClaw",
            "welcome": "Welcome to QiQiClaw! Type your message or /help for commands.",
...
[dim #4A4A4A]⠀⠀⠀⠀⠀⠀⠀⠀⠀the boulder⠀⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "charizard": {
        ...
        "branding": {
            "agent_name": "QiQiClaw Agent",
            "welcome": "Welcome to QiQiClaw Agent! Type your message or /help for commands.",
            "goodbye": "Flame out! ✦",
            "response_label": " ✦ QiQiClaw ",
            "prompt_symbol": "✦",
            "help_header": "(✦) Available Commands",
        },
        "tool_prefix": "│",
