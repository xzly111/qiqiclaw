...
Built for [QIQI-Claw](https://github.com/xzly111/qiqiclaw). Usable in any coding agent. Canonical source lives here; synced to [`xzly111/qiqiclaw/skills/creative/ascii-video`](https://github.com/xzly111/qiqiclaw/tree/main/skills/creative/ascii-video) via PR.
