...
Control the user's Spotify account via the QiQi Spotify toolset (7 tools). Setup guide: https://qiqiclaw.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `qiqiclaw auth spotify` again.
