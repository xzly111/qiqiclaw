...
```python
import sys
sys.path.insert(0, "/home/teknium/.qiqiclaw/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.qiqiclaw/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — QiQi installs package this)
