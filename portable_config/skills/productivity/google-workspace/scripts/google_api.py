#!/usr/bin/env python3
"""Google Workspace API CLI for QiQi claw.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing QiQi claw-facing JSON contract and falls back to the Python client
...
from _qiqiclaw_home import get_qiqiclaw_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for QiQi claw")
