...
describe('assistant-ui streaming renderer', () => {
  ...
  it('renders assistant text incrementally before completion', async () => {
    ...
    expect(screen.getByRole('status', { name: 'QiQiClaw is loading a response' })).toBeTruthy()
    ...
    expect(screen.queryByRole('status', { name: 'QiQiClaw is loading a response' })).toBeNull()
  ...
  it('renders an incomplete streaming reasoning fenced code block as a code card', async () => {
    ...
    await waitFor(() => {
      expect(container.querySelector('[data-slot="aui_reasoning-text"]')?.textContent).toContain('const answer')
    })
