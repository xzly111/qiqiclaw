...
export const en: Translations = {
  ...
  boot: {
    ready: 'QiQiClaw Desktop is ready',
    ...
    errors: {
      ...
      backgroundExitedDuringStartup: 'QiQiClaw background process exited during startup.',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting QiQiClaw Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to QiQiClaw defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let QiQiClaw follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'QiQiClaw checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading QiQiClaw configuration...',
    ...
    gateway: {
      ...
      intro:
        'QiQiClaw Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running QiQiClaw backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset QIQICLAW_DESKTOP_REMOTE_URL and QIQICLAW_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private QiQiClaw backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote QiQiClaw backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'QiQiClaw Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · QiQiClaw ${version}` : ''}`,
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure QiQiClaw desktop' },
      skills: { title: 'Skills & Tools', detail: 'Enable skills, toolsets, and providers' },
      messaging: { title: 'Messaging', detail: 'Set up Telegram, Slack, Discord, and more' },
      artifacts: { title: 'Artifacts', detail: 'Browse generated outputs' },
      workflow: { title: 'Workflow', detail: 'Open workflow orchestration' }
    },
    sectionEntries: {
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent QiQiClaw environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. QiQiClaw will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting QiQiClaw...',
    placeholderReconnecting: 'Reconnecting to QiQiClaw…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give QiQiClaw a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'QiQiClaw will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of QiQiClaw can’t update itself from inside the app.',
    connectionRetry: 'Check your connection and try again.',
    latestBody: 'You’re running the latest version.',
    allSetTitle: 'You’re all set',
    availableTitle: 'New update available',
    availableBody: 'A new version of QiQiClaw is ready to install.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed QiQiClaw from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'QiQiClaw will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The QiQiClaw updater will take over in its own window and reopen QiQiClaw when it’s done.',
    applyingClose: 'QiQiClaw will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'QiQiClaw needs a one-time install',
    ...
    settingUpTitle: 'Setting up QiQiClaw',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another QiQiClaw CLI or desktop instance is running. Stop any running QiQiClaw instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The QiQiClaw installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with QiQiClaw",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'QiQiClaw is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting QiQiClaw…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run QiQiClaw',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point QiQiClaw at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — QiQiClaw connects automatically',
      loopback: 'Opens your browser to sign in — QiQiClaw connects automatically',
    ...
    authorizeThere: 'Authorize QiQiClaw there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize QiQiClaw there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'QiQiClaw inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. QiQiClaw will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'QiQiClaw is restarting...',
      askRestart: 'Ask QiQiClaw to restart the server',
      lookingRestart: taskId => `QiQiClaw is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'QiQiClaw is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `QiQiClaw finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'QiQiClaw could not restart the server.',
      stillWorking:
        'QiQiClaw is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'QiQiClaw is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'QiQiClaw gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.qiqiclaw/config.yaml). QiQiClaw won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'QiQiClaw needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'QiQiClaw needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart QiQiClaw Desktop to use Save Image.',
    restartToSaveImages: 'Restart QiQiClaw Desktop to save images',
