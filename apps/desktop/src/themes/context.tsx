...
const SKIN_KEY = 'qiqiclaw-desktop-theme-v2'
const MODE_KEY = 'qiqiclaw-desktop-mode-v1'
...
/** Sync the desktop skin with the active QiQiClaw backend theme on connect. */
