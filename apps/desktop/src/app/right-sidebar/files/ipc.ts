...
import type { QiQiClawReadDirEntry, QiQiClawReadDirResult } from '@/global'

export type ProjectTreeEntry = QiQiClawReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: QiQiClawReadDirEntry) {
...
async function filterIgnored(entries: QiQiClawReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<QiQiClawReadDirResult> {
