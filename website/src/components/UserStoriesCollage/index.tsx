  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the QIQI-Claw community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use QiQiClaw &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with QiQiClaw?{' '}
        <a
          href="https://github.com/xzly111/qiqiclaw/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
