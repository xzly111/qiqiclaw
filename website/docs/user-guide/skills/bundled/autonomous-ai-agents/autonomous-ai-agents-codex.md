...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the QiQiClaw terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For QiQiClaw itself, `model.provider: openai-codex` uses QiQiClaw-managed Codex
...
When invoking the Codex CLI from a QiQiClaw gateway/service context (for example,
