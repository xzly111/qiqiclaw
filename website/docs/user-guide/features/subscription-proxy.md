...
chat completions — use your QiQiClaw-managed provider subscription as their
...
| Use case | "Use QiQiClaw as a chat backend" | "Use my Portal sub from another app" |
...
This opens your browser for the Nous Portal OAuth flow. QiQiClaw stores
the refresh token in `~/.hermes/auth.json` — the same place all QiQiClaw
...
Model:      QiQiClaw-4-70B    # or QiQiClaw-4.3-36B, QiQiClaw-4-405B
```
