...
description: "Reference for QiQiClaw core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call QiQiClaw tools programmatically. |
