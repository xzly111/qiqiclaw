...
description: "How to build a memory provider plugin for QIQI-Claw"
---

# Building a Memory Provider Plugin

Memory provider plugins give QIQI-Claw persistent, cross-session knowledge beyond the built-in MEMORY.md and USER.md. This guide covers how to build one.
...
the `messages` parameter; QiQiClaw will continue calling them with the legacy
signature.
