---
sidebar_position: 8
title: "Use Voice Mode with QiQiClaw"
description: "A practical guide to setting up and using QiQiClaw voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with QiQiClaw
...
- you want QiQiClaw sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in QiQiClaw.
...
## Step 1: make sure normal QiQiClaw works first
...
QiQiClaw supports both local and cloud speech stacks.
...
4. QiQiClaw transcribes and responds
...
- asking QiQiClaw to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full QiQiClaw loop.

## Tuning CLI behavior

### Silence threshold

If QiQiClaw starts/stops too aggressively, tune:
...
QiQiClaw stays a normal chat bot, but can speak replies.
...
- you want QiQiClaw to function like a portable research or ops assistant
...
QiQiClaw joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- QiQiClaw detects speech boundaries
- transcripts are posted in the associated text channel
- QiQiClaw responds in text and audio
