...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](./webhook-github-pr-review.md) — GitHub pushes events to QiQiClaw instantly when PRs are opened or updated.
:::
...
- **QIQI-Claw installed** — see the [Installation guide](/getting-started/installation)
...
Make sure QiQiClaw can access GitHub. Start a chat:
...
Still in the chat, ask QiQiClaw to review a real PR:
...
A skill gives QiQiClaw consistent review guidelines that persist across sessions and cron runs. Without one, review quality varies.
...
This is what makes the reviewer actually useful. Start a session and teach QiQiClaw your team's standards:
...
2. Teach QiQiClaw your conventions via memory (Step 4)
