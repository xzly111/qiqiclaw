...
const DEFAULT_REPLY_PREFIX = '⚕ *QIQI-Claw*\n────────────\n';
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['QIQI-Claw', 'Chrome', '120.0'],
  ...
  sock.ev.on('messages.upsert', async ({ messages, type }) => {
    ...
    for (const msg of messages) {
      ...
      // Ignore QiQiClaw's own reply messages in self-chat mode to avoid loops.
