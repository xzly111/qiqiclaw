...
class _ConstructibleDiscordThread:
    pass


class _ConstructibleDiscordDMChannel:
    pass


class _ConstructibleDiscordForumChannel:
    pass
...
class _FakeThreadChannel(_ConstructibleDiscordThread):
...
def _stub_constructible_discord_channel_types(monkeypatch):
    monkeypatch.setattr(_discord_mod, "Thread", _ConstructibleDiscordThread)
    monkeypatch.setattr(_discord_mod, "DMChannel", _ConstructibleDiscordDMChannel)
    monkeypatch.setattr(_discord_mod, "ForumChannel", _ConstructibleDiscordForumChannel)
