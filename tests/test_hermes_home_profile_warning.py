...
profile is active, get_hermes_home() should:
  1. STILL return ~/.qiqiclaw (raising would brick 30+ module-level callers)
...
class TestGetHermesHomeProfileWarning:
    def test_classic_mode_no_active_profile_no_warning(
        ...
        """Classic mode: no active_profile file → silent, returns ~/.qiqiclaw."""
    ...
    def test_default_active_profile_no_warning(
        ...
        """active_profile=default → still no warning, returns ~/.qiqiclaw."""
