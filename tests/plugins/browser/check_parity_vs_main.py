...
Run from the PR worktree:
    ...
    cd ~/.qiqiclaw/hermes-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.qiqiclaw/hermes-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.qiqiclaw/hermes-agent
