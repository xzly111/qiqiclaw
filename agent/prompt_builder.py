...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on QIQI-Claw (by Nous Research). When the user needs help with "
    "QiQiClaw itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "the documentation at https://github.com/xzly111/qiqiclaw#readme is your "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot QIQI-Claw itself — its CLI, config, models, providers, tools, "
