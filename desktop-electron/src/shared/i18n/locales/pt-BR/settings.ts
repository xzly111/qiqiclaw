export default {
  ...
  analytics: {
    ...
    hint: "Ajuda a melhorar o QiQiClaw enviando dados de uso anônimos e agregados para a instância PostHog do projeto (hospedada na UE). Você pode desativar a qualquer momento.",
    disclosure: {
  ...
  updateSuccess: "QiQiClaw atualizado com sucesso.",
  ...
  modelNotDiscovered:
    "Este modelo não está na lista retornada pelo provedor, então não será adicionado à biblioteca de modelos",
  customBaseUrlHint: "Endpoint da API compatível com OpenAI",
  poolHint:
    "Adicione várias chaves de API para o mesmo provedor para rotação automática e balanceamento de carga. O QiQiClaw alternará entre elas.",
  add: "Adicionar",
  remove: "Remover",
  keyLabel: "Chave",
  empty: "(vazio)",
  dataSection: "Dados",
  dataHint:
    "Exporte ou importe sua configuração do QiQiClaw, sessões, habilidades e memória.",
  ...
  migrationDesc:
    "Encontramos o OpenClaw em <code>{{path}}</code>. Você pode migrar sua configuração, chaves de API, sessões e habilidades para o QiQiClaw.",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "Usando o QiQiClaw instalado neste dispositivo",
  modeRemoteHint:
    "Conectar a um servidor da API do QiQiClaw na sua rede ou nuvem",
  remoteUrl: "URL Remota",
  remoteUrlHint:
    "A URL do servidor da API do QiQiClaw (deve expor /health e /v1/chat/completions)",
  ...
  serverConfigHint:
    "Você está conectado a um servidor remoto do QiQiClaw. A seleção de modelos, as chaves de API dos provedores e as credenciais são gerenciadas no host remoto em <code>~/.qiqiclaw/.env</code> e <code>config.yaml</code>. Edite-os lá e reinicie o servidor.",
  connectionMode: "Modo",
