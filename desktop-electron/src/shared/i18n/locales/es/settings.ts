export default {
  ...
  analytics: {
    ...
    hint: "Ayuda a mejorar QiQiClaw enviando datos de uso anónimos y agregados a la instancia PostHog del proyecto (alojada en la UE). Puedes desactivarlo en cualquier momento.",
    disclosure: {
  ...
  updateSuccess: "QiQiClaw se actualizó correctamente.",
  ...
  modelNotDiscovered:
    "Este modelo no está en la lista devuelta por el proveedor, así que no se añadirá a la biblioteca de modelos",
  customBaseUrlHint: "Endpoint de API compatible con OpenAI",
  poolHint:
    "Agrega varias API keys para el mismo proveedor para la rotación automática y el equilibrio de carga. QiQiClaw alternará entre ellas.",
  add: "Agregar",
  remove: "Quitar",
  keyLabel: "Clave",
  empty: "(vacío)",
  dataSection: "Datos",
  dataHint:
    "Exporta o importa tu configuración de QiQiClaw, sesiones, habilidades y memoria.",
  ...
  migrationDesc:
    "Se encontró OpenClaw en <code>{{path}}</code>. Puedes migrar tu configuración, API keys, sesiones y habilidades a QiQiClaw.",
  migrationDismiss: "No volver a mostrar",
  migrating: "Migrando...",
  migrateToQiQiClaw: "Migrar a QiQiClaw",
  skip: "Omitir",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "Usando QiQiClaw instalado en este dispositivo",
  modeRemoteHint:
    "Conectarse a un servidor de API de QiQiClaw en tu red o en la nube",
  remoteUrl: "URL remota",
  remoteUrlHint:
    "La URL del servidor de API de QiQiClaw (debe exponer /health y /v1/chat/completions)",
  ...
  serverConfigHint:
    "Estás conectado a un servidor remoto de QiQiClaw. La selección de modelos, las API keys de proveedores y las credenciales se administran en <code>~/.qiqiclaw/.env</code> y <code>config.yaml</code> del servidor. Edítalos en el host (por ejemplo, <code>docker exec -it hermes vi /opt/data/.env</code>) y reinicia el contenedor.",
  connectionMode: "Modo",
