class QiQiClawAgent < Formula
  ...
  url "https://github.com/xzly111/qiqiclaw/releases/download/v2026.3.30/hermes_agent-0.6.0.tar.gz"
  ...
  test do
    assert_match "QIQI-Claw v#{version}", shell_output("#{bin}/hermes version")
